export function registrationConfirmationTemplate(params: {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:24px;color:#222;line-height:1.5">
    ...
    <p>Thank you for registering for the <strong>Managers Training - Operational Excellence 2026</strong>.</p>
    <p><strong>Date:</strong> 5th January 2026<br/>
       <strong>Venue:</strong> Salons Assured Offices<br/>
       ${params.amount ? `<strong>Amount:</strong> ${params.amount}<br/>` : ''}</p>
    <p>We'll share logistics and preparation material as the training approaches.</p>
